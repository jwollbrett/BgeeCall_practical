...
For this course, you will need R.3.6 or later, which you can download from https://cran.r-project.org/ (if you are using RStudio cloud, that is recommended for this course, this is not necessary) and Bioconductor software version 3.10.
